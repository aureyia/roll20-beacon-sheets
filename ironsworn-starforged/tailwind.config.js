  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        "accordion-down": {
          from: { height: 0 },
          to: { height: "var(--radix-accordion-card-content-height)" },
        },
        "accordion-up": {
          from: { height: "var(--radix-accordion-card-content-height)" },
          to: { height: 0 },
        },
        "collapsible-down": {
          from: { height: 0 },
          to: { height: 'var(--radix-collapsible-card-content-height)' },
        },
        "collapsible-up": {
          from: { height: 'var(--radix-collapsible-card-content-height)' },
          to: { height: 0 },
        },
      },
      animation: {
