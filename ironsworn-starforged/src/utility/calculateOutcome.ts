...
if (import.meta.vitest) {
  ...
  describe('calculateOutcome', () => {
    it('opportunity', () => {
      ...
      expect(calculateOutcome(10, inputDice)).toStrictEqual({
        outcome: 'opportunity',
        dice: outputDice,
      });
    });
    it('complication', () => {
      ...
      expect(calculateOutcome(1, inputDice)).toStrictEqual({
    ...
    it('strong-hit', () => {
      ...
      expect(calculateOutcome(5, inputDice)).toStrictEqual({
        outcome: 'strong-hit',
        dice: outputDice,
      });
    });
    it('weak-hit-1', () => {
      ...
      expect(calculateOutcome(4, inputDice)).toStrictEqual({
        outcome: 'weak-hit',
        dice: outputDice,
      });
    });
    it('weak-hit-2', () => {
      ...
      expect(calculateOutcome(7, inputDice)).toStrictEqual({
        outcome: 'weak-hit',
        dice: outputDice,
      });
    });
