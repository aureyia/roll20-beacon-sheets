    ...
    results: {
        'dice-0': {
            ...
            results: {
                ...
                dice: [Effect.runSync(number_between(seed, 'dice-0', 1, 6))],
                expression: '1d6',
                rolls: [
                    {
                        sides: 6,
                        dice: 1,
                        results: [Effect.runSync(number_between(seed, 'dice-0', 1, 6))],
                    },
                ],
            },
        },
        'dice-1': {
            ...
            results: {
                ...
                dice: [Effect.runSync(number_between(seed, 'dice-1', 1, 10))],
                expression: '1d10',
                rolls: [
                    {
                        sides: 10,
                        dice: 1,
                        results: [Effect.runSync(number_between(seed, 'dice-1', 1, 10))],
                    },
                ],
            },
        },
        'dice-2': {
            ...
            results: {
                ...
                dice: [Effect.runSync(number_between(seed, 'dice-2', 1, 10))],
                expression: '1d10',
                rolls: [
                    {
                        sides: 10,
                        dice: 1,
                        results: [Effect.runSync(number_between(seed, 'dice-2', 1, 10))],
                    },
                ],
            },
        },
