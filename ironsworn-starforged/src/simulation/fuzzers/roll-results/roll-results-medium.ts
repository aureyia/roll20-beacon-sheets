...
export const rollResults = (seed: string) => ({
  ...
  results: {
    'dice-0': {
      ...
      expression: '1d6',
      results: {
        result: Effect.runSync(numberBetween(seed, 'dice-0', -20, 20)),
        dice: [Effect.runSync(numberBetween(seed, 'dice-0', -20, 20))],
        expression: '1d6',
        rolls: [
          {
            sides: 6,
            dice: 1,
            results: [Effect.runSync(numberBetween(seed, 'dice-0', -20, 20))],
          },
        ],
      },
    },
    'dice-1': {
      ...
      expression: '1d10',
      results: {
        result: Effect.runSync(numberBetween(seed, 'dice-1', -20, 20)),
        dice: [Effect.runSync(numberBetween(seed, 'dice-1', -20, 20))],
        expression: '1d10',
        rolls: [
          {
            sides: 10,
            dice: 1,
            results: [Effect.runSync(numberBetween(seed, 'dice-1', -20, 20))],
          },
        ],
      },
    },
    'dice-2': {
      ...
      expression: '1d10',
      results: {
        result: Effect.runSync(numberBetween(seed, 'dice-2', -20, 20)),
        dice: [Effect.runSync(numberBetween(seed, 'dice-2', -20, 20))],
        expression: '1d10',
        rolls: [
          {
            sides: 10,
            dice: 1,
            results: [Effect.runSync(numberBetween(seed, 'dice-2', -20, 20))],
          },
        ],
      },
    },
